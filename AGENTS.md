...
This project is indexed by GitNexus as **fund-watch** (789 symbols, 2040 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
